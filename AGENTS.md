# Integration Changelog Watch (`integration-changelog-watch`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://integration-changelog-watch.sociobot.in`. Artifact class: `web-with-backend`.
