...
- “See matched notices, owners, and checks.” — 6
...
Terminology: vendor feed → watch; matching release note → action card; responsible engineer → owner; local verification → check command; sandbox → demo; browser-held credential → workspace token.
